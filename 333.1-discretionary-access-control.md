...
<table><thead><tr><th>command</th><th>description</th><th data-hidden></th></tr></thead><tbody><tr><td><code>setfacl -m u:lisa:r file</code></td><td>Granting an additional user read access</td><td></td></tr><tr><td><code>setfacl -m m::rx file</code></td><td>Revoking write access from all groups and all named users (using the effective rights mask)</td><td></td></tr><tr><td><code>setfacl -x g:staff file</code></td><td>Removing a named group entry from a file’s ACL</td><td></td></tr><tr><td><code>getfacl file1 | setfacl --set-file=- file2</code></td><td>Copying the ACL of one file to another</td><td></td></tr><tr><td><code>getfacl --access dir | setfacl -d -M- dir</code></td><td>Copying the access ACL into the Default ACL</td><td></td></tr></tbody></table>
