...
{% hint style="success" %}
That was a quick overview of DNS, for more information visit my LPIC2 book: [https://borosan.gitbook.io/lpic2-exam-guide/2071-basic-dns-server-configuration](https://borosan.gitbook.io/lpic2-exam-guide/2071-basic-dns-server-configuration)
{% endhint %}
