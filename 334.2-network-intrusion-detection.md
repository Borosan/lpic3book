...
| ----------------- | --------------------------------------------------------------- | - |
| openvas-mkcert -q | quickly generate a new certificate, without asking any question |   |
| openvas-mkcert -f | force over writing of already existing certificate files        |   |
