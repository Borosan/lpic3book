...
* Edit /etc/audisp/plugins.d/au\_remote.conf&#x20;

&#x20;         Set active=yes&#x20;

* Edit /etc/audisp/audisp-remote.conf&#x20;

&#x20;         Set remote\_server = target-server-hostname

&#x20;Configure auditd server :

* Edit /etc/audi/auditd.conf:

&#x20;        Set tcp\_listen\_port = \<port\_num>&#x20;

_Note there is not a default port Set SELinux port_ _context for chosen port_&#x20;
