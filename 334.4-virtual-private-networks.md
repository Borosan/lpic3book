...
first Enable the Wireguard repository.

```
[root@rocky8 ~]# dnf copr enable jdoss/wireguard
...
```
[root@rocky8 ~]# dnf install wireguard-dkms wireguard-tools
```
...
#### &#x20;<a href="#step-configure-firewall" id="step-configure-firewall"></a>
