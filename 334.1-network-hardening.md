...
<table><thead><tr><th>tcpdump command</th><th>Description</th><th data-hidden></th></tr></thead><tbody><tr><td>tcpdump -D</td><td>Display available interfaces</td><td></td></tr><tr><td>tcpdum -i ens33</td><td>Capture Packets from specific interface</td><td></td></tr><tr><td>tcpdump -c 10 -i ens33</td><td>Capture only N neumber of packets</td><td></td></tr><tr><td>tcpdump -w myfile.pcap -i ens33</td><td>Capture and save packets in a file</td><td></td></tr><tr><td>tcpdump -r myfile.pcap</td><td>Read captured packets file</td><td></td></tr><tr><td>tcpdump -n -i ens33</td><td>Capture IP address Packets</td><td></td></tr><tr><td>tcpdum -i ens33 tcp</td><td>Only TCP Packets are captured</td><td></td></tr><tr><td>tcpdump -i ens33 port 22</td><td>Capture packets from specific  port</td><td></td></tr><tr><td>tcpdump -i eth0 src 192.168.10.150</td><td>Capture packets from source IP</td><td></td></tr><tr><td>tcpdump -i eth0 dst 209.85.144.139</td><td>Capture packets from destination IP</td><td></td></tr><tr><td>tcpdump -i ens33 ipv6</td><td>Sniffing for IPv6</td><td></td></tr></tbody></table>
...
**tshark**. The terminal version of Wireshark supports similar options and is a lot useful when a Graphical User Interface (GUI) isn’t available.
